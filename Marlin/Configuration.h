...
#define STRING_CONFIG_H_AUTHOR "(uncle-yura)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "koZZel"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 135.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 120.0              // (mm) Get this value from G33 auto calibrate
